...
%{?dlrn: %global tarsources glance-store}
%{!?dlrn: %global tarsources glance_store}
...
Source0:        https://tarballs.openstack.org/%{upstream_name}/%{tarsources}-%{upstream_version}.tar.gz
# Required for tarball sources verification
%if 0%{?sources_gpg} == 1
Source101:        https://tarballs.openstack.org/%{upstream_name}/%{tarsources}-%{upstream_version}.tar.gz.asc
...
%endif
%autosetup -S git -n %{tarsources}-%{upstream_version}
